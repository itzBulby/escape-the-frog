 ...
 * that perform operations on the LED matrix (only once at the start) !!!
 *
...
/*
 * Set the single LED at <led_num> to the RGB565 <color>, where LEDs are
 * indexed from 0 at top left and then left-to-right, top-to-bottom order.
 */
void set_led_num(int led_num, uint16_t color) {
